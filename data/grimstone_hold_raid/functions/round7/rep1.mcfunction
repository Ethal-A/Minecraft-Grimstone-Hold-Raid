...
summon illageandspillage:magispeller 210 310 -3 {Tags:["ghr_hostile", "ghr_boss"], CustomName:'[{"text":"Magispeller"}]', Attributes:[{Name:"generic.max_health",Base:6000f}], Health:6000, ForgeData: {InfernalMobsMod: ""}}
