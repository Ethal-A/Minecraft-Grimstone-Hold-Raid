...
summon illageandspillage:spiritcaller 210 310 -3 {Tags:["ghr_hostile", "ghr_boss"], CustomName:'[{"text":"Spiritcaller"}]', Attributes:[{Name:"generic.max_health",Base:1500f}], Health:1500, ForgeData: {InfernalMobsMod: ""}}
