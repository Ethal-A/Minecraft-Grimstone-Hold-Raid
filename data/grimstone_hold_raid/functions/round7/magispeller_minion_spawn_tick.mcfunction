...
execute at @e[name="Magispeller"] run summon illageandspillage:illashooter ~2 ~ ~2 {Tags:["ghr_hostile", "ghr_boss_minion"], CustomName:'[{"text":"Magispeller Minion"}]', ForgeData: {InfernalMobsMod: "notInfernal"}}
