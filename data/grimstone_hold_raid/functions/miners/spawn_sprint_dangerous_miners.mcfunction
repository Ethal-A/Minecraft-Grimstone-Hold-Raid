tellraw @a {"text":"Quick and dangerous miners have been dispatched to break down your defences", "color":"red"}

# Spawn area 1: 5055 308 -2100
summon minecraft:zombie 5055 308 -2100 {Tags:["ghr_hostile", "ghr_hostile_miner"], CustomName:'[{"text":"Quick Dangerous Miner"}]', HandItems: [{id:stone_sword,Count:1}, {id: "minecraft:stone_pickaxe", tag: {Damage: 0}, Count: 1b}], ForgeData: {InfernalMobsMod: "notInfernal", "enhancedai:time_to_break_multiplier": 1.0d, "enhancedai:miner": 1b, "enhancedai:sprint": 1b}, ArmorItems:[{id:leather_boots,tag:{display:{color:16776960}},Count:1},{id:leather_leggings,tag:{display:{color:16776960}},Count:1},{id:leather_chestplate,tag:{display:{color:16776960}},Count:1},{id:leather_helmet,tag:{display:{color:16776960}},Count:1}],ArmorDropChances:[0f,0f,0f,0f], Attributes:[{Name:"generic.max_health",Base:20f}], ActiveEffects:[{Id:12,Duration:10,ShowParticles:1b}], Health:20}
