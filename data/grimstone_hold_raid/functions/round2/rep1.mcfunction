...
summon illageandspillage:absorber 210 310 -3 {Tags:["ghr_hostile", "ghr_boss", "ghr_cause_bleeding"], CustomName:'[{"text":"Goliath"}]', Attributes:[{Name:"generic.max_health",Base:1200f}], Health:1200, ForgeData: {InfernalMobsMod: ""}}
